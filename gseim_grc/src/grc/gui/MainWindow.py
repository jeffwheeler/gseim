...
#       Gtk.ApplicationWindow.__init__(self, title="GNU Radio Companion", application=app)
        Gtk.ApplicationWindow.__init__(self, title="GSEIM", application=app)
        log.debug("__init__()")
        ...
        self.set_icon_from_file(str(files("grc").joinpath("data", "icon.png")))
    ...
    def new_page(self, file_path='', show=False):
        ...
        try: #try to load from file
            print('MainWindow.py: loading', file_path)
